...
<div class="page-wrapper">
    ...
    <video class="banner" autoplay muted loop playsinline>
        <source src="../vids/cv204.mp4" type="video/mp4">
    </video>

    
    <div class="page-hero-title">
        <h1>Centro Villa 204</h1>
       ...
       <div class="room-slider">
            ...
            <div class="slider-track" id="sliderTrack">
                ...
                <img src="../rooms/cv204/cv204.jpg">
                <img src="../rooms/cv204/cv204(1).jpg">
                <img src="../rooms/cv204/cv204(2).jpg">
                <img src="../rooms/cv204/cv204(3).jpg">
                <img src="../rooms/cv204/cv204(4).jpg">
