...
<div class="page-wrapper">
    ...
    <video class="banner" autoplay muted loop playsinline>
        <source src="../vids/dr202.mp4" type="video/mp4">
    </video>

    
    <div class="page-hero-title">
        <h1>De Luxe Room 202</h1>
       ...
       <div class="room-slider">
            ...
            <div class="slider-track" id="sliderTrack">
                ...
                <img src="../rooms/dr202/dr202(1).jpg">
                <img src="../rooms/dr202/dr202(2).jpg">
                <img src="../rooms/dr202/dr202(3).jpg">
                <img src="../rooms/dr202/dr202(4).jpg">
                <img src="../rooms/dr202/dr202(5).jpg">
