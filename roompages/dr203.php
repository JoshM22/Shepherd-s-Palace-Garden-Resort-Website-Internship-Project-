...
<div class="page-wrapper">
    ...
    <video class="banner" autoplay muted loop playsinline>
        <source src="../vids/dr203.mp4" type="video/mp4">
    </video>

    
    <div class="page-hero-title">
        <h1>De Luxe Room 203</h1>
       ...
       <div class="room-slider">
            ...
            <div class="slider-track" id="sliderTrack">
                ...
                <img src="../rooms/dr203/dv203(1).jpg">
                <img src="../rooms/dr203/dv203(2).jpg">
                <img src="../rooms/dr203/dv203(3).jpg">
                <img src="../rooms/dr203/dv203(4).jpg">
                <img src="../rooms/dr203/dv203(5).jpg">
