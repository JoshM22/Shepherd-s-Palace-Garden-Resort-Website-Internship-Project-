...
<div class="page-wrapper">
    ...
    <video class="banner" autoplay muted loop playsinline>
        <source src="../vids/cv202.mp4" type="video/mp4">
    </video>

    
    <div class="page-hero-title">
        <h1>Centro Villa 201</h1>
       ...
       <div class="room-slider">
            ...
            <div class="slider-track" id="sliderTrack">
                ...
                <img src="../rooms/cv202/cv202.jpg">
                <img src="../rooms/cv202/cv202(1).jpg">
                <img src="../rooms/cv202/cv202(2).jpg">
                <img src="../rooms/cv202/cv202(3).jpg">
                <img src="../rooms/cv202/cv202(4).jpg">
                <img src="../rooms/cv202/cv202(5).jpg">
