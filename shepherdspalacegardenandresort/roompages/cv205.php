...
<div class="page-wrapper">
    ...
    <video class="banner" autoplay muted loop playsinline>
        <source src="../vids/cv205.mp4" type="video/mp4">
    </video>

    
    <div class="page-hero-title">
        <h1>Centro Villa 205</h1>
       ...
       <div class="room-slider">
            ...
            <div class="slider-track" id="sliderTrack">
                ...
                <img src="../rooms/cv205/cv205.jpg">
                <img src="../rooms/cv205/cv205(1).jpg">
                <img src="../rooms/cv205/cv205(2).jpg">
                <img src="../rooms/cv205/cv205(3).jpg">
                <img src="../rooms/cv205/cv205(4).jpg">
                <img src="../rooms/cv205/cv205(5).jpg">
