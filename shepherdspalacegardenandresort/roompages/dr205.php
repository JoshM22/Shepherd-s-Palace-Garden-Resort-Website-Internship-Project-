...
<div class="page-wrapper">
    ...
    <video class="banner" autoplay muted loop playsinline>
        <source src="../vids/dv205.mp4" type="video/mp4">
    </video>

    
    <div class="page-hero-title">
        <h1>De Luxe Room 205</h1>
       ...
       <div class="room-slider">
            ...
            <div class="slider-track" id="sliderTrack">
                ...
                <img src="../rooms/dr205/dv205.jpg">
                <img src="../rooms/dr205/dv205(1).jpg">
                <img src="../rooms/dr205/dv205(2).jpg">
                <img src="../rooms/dr205/dv205(3).jpg">
