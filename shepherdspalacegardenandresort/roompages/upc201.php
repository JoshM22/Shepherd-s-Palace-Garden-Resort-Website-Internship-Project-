...
<div class="page-wrapper">
    ...
    <video class="banner" autoplay muted loop playsinline>
        <source src="../vids/upc201.mp4" type="video/mp4">
    </video>

    
    <div class="page-hero-title">
        <h1>Upper Castle 201</h1>
       ...
       <div class="room-slider">
            ...
            <div class="slider-track" id="sliderTrack">
                ...
                <img src="../rooms/upc201/upc201(1).jpg">
                <img src="../rooms/upc201/upc201(5).jpg">
                <img src="../rooms/upc201/upc201(7).jpg">
                <img src="../rooms/upc201/upc201(8).jpg">
